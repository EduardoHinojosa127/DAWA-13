...
app.get('/api/videojuegos', videojuegoController.getVideojuegos);
app.get('/api/videojuegos/:id', videojuegoController.getVideojuegoById);
app.post('/api/videojuegos', videojuegoController.createVideojuego);
app.put('/api/videojuegos/:id', videojuegoController.updateVideojuego);
app.delete('/api/videojuegos/:id', videojuegoController.deleteVideojuego);
// Iniciar el servidor
app.listen(port, () => {
